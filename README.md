...
```javascript
FLOAT32_SQRT_PHI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-sqrt-phi@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-sqrt-phi/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float32-sqrt-phi/actions/workflows/test.yml?query=branch:v0.1.1
